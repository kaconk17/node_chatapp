...
const createChatTable = () => {
    const sqlquery = 'CREATE TABLE IF NOT EXISTS tb_chat (id UUID PRIMARY KEY,chatroom_id VARCHAR(100) NOT NULL,pesan TEXT NOT NULL,posted_by VARCHAR(100) NOT NULL, created_at TIMESTAMP,updated_at TIMESTAMP)';
    pool.query(sqlquery)
    .then((res)=>{
        console.log(res);
        pool.end();
